...
public class ConfReservationsPage extends BasePageObject {
	
	@FindBy(id = "search-type-toggle")
	...
	public ConfReservationsPage(WebDriver driver, String env){
		super(driver, env);
	//	this.driver = driver;
		PageFactory.initElements(driver, this);
	}	

	public ConfReservationsPage(WebDriver driver, String env, UrlBuilder ub){
		super(driver, env, ub);
	//	this.driver = driver;
		PageFactory.initElements(driver, this);
